        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    productOrder_ProductId = table.Column<int>(type: "int", nullable: true),
                    productOrder_ProductName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    productOrder_PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
